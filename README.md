...
- **Editor** — ProseMirror-based WYSIWYG with seamless mode, LaTeX math, interactive tables with DnD, built-in spellcheck, focus modes, suggestion mode, and interactive ToC
- **Desktop** — Electron app with offline spellchecking, customizable day/night themes, local file system access, and publishing to type-club.ru
